            ...
            <div style="width: 100%; float: left;">
                <table style="border-collapse: collapse;">
                    ...
                    <tr>
                        ...
                        <td style="height: 30px; width: 60px;">Qty <br><center style="font-size: 20px;"><?php echo $l->qty_actual?></center></td>
                        <td style="height: 30px; width: 60px;">Weight <br><center style="font-size: 20px;"><?php echo $l->weight_actual?></center></td>
                    </tr>
                    <tr>
